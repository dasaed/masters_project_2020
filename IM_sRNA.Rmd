...
# G) Combined Insights
By looking at LIME, SHAP, and PDPs(Random Forest Explorer), we can combine the insights a get 


## H2O PDP 
H2O's current PDPs implementa

```{r}
h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "Distance", plot=TRUE, nbins=2)
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "SS")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "Pos10wrtsRNAStart")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "DistTerm")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "Distance")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "DownDistance")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "sameStrand")
#h2o.partialPlot(rfh2o, data = as.h2o(trainDataSet), cols = "sameDownStrand")
```
