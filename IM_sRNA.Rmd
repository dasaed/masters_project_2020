...
Random Forest explainer is a library that allows the user to understand the structure the structure of a random forest by exploring its nodes, feature importance, and finding relationships between the main features. Most of the graphs generated by the RFE
...
# * Mmin depth in this package seems to mean what is the first time this variable is used to split the tree
